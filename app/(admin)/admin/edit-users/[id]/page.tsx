// app/admin/edit-users/[id]/page.tsx
'use client';
    ...
    try {
      ...
      if (result.success && result.data && result.data.length > 0) {
        ...
        setFormData({
          ...
          package: typeof userData.package === 'object' && userData.package ? userData.package._id : (userData.package || null),
          role: userData.role,
        });
      } else {
        ...
        <div className="space-y-6 p-6">
            ...
            <div className="relative z-0 py-8 px-6">
              <div className="flex items-center justify-between flex-wrap gap-4">
                <div>
                  ...
                  <p className="text-blue-100">Update customer information and settings</p>
                </div>
                <button
          ...
          <div className="rounded-2xl bg-white dark:bg-gray-900 shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
            <form onSubmit={handleSubmit} className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    Inactive customers will not be able to access their account
                  </p>
                </div>
              </div>
              ...
              {/* Preview Section */}
              <div>
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Customer Preview</h3>
                <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold shadow-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 space-y-1">
                        ...
                        <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <span>
                            {formData.package 
                              ? packages.find(p => p._id === formData.package)?.name || 'Loading...'
                              : 'No package assigned'}
                          </span>
                        </div>
                      </div>
